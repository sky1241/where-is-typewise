...
Returns thread dicts shaped to match the `threads` SQLite schema in BATTLE_PLAN.md
...
def search(
    ...
    *,
    ...
    Args:
        ...
        max_results: hitsPerPage cap (Algolia maxes at 1000 but 50 is the BATTLE_PLAN default).
